...
const SearchCourse: React.FC<{onSearchCourse : (course : string) => void}> = (props) =>  {
    ...
    <Form onSubmit = {searchCourseHandler}>
      <Form.Group className="mb-3" controlId="formBasicSearch">
        ...
        <Form.Control type="text" placeholder="Ex: COMP 250" value = {enteredCourse} onChange = {courseChangeHandler} ref = {searchInputRef}/>
      </Form.Group>
